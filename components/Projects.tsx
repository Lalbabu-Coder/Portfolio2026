...
export default function Projects() {
  return (
    <section id="projects" className="py-24 sm:py-32 px-4 sm:px-6 md:px-20 relative overflow-hidden bg-transparent text-white w-full max-w-full border-t border-white/10">
      {/* Front-page matching cosmic ambient neon glows */}
      ...
      <div className="absolute left-1/2 top-1/3 -translate-x-1/2 w-[40vw] max-w-[400px] h-[40vw] max-h-[400px] bg-blue-600/10 blur-[180px] rounded-full pointer-events-none z-0" />
